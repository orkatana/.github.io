...
(function () {
    ...
    ShapeService.prototype.setBaseShapes = function (canvasPosition) {
        ...
        // 座標を設定
          baseShape[0] = {
            ...
            'rotate': 0,   // 回転角度
            'color': ['rgba(204,221,128,1)'], //図形の色
            'mark_img':'./img/g.png',
            'matrix': [
                [canvasPosition.width * 0.579, canvasPosition.height * 0.392],
                [canvasPosition.width * 0.695, canvasPosition.height * 0.444],
                [canvasPosition.width * 0.792, canvasPosition.height * 0.391],
                [canvasPosition.width * 0.753, canvasPosition.height * 0.328],
            ],     // 各頂点の座標
        ...
        baseShape[1] = {
            ...
            'mark_img':'./img/h.png',
            'matrix': [
                [canvasPosition.width * 0.74, canvasPosition.height * 0.602],
                [canvasPosition.width * 0.88, canvasPosition.height * 0.531],
                [canvasPosition.width * 0.943, canvasPosition.height * 0.383],
                [canvasPosition.width * 0.869, canvasPosition.height * 0.362],
            ],     // 各頂点の座標
            'origin': {     // 回転時の座標計算用に元座標を保存
                'crossPoint': [],
                'circle': [],
        ...
        baseShape[2] = {
            ...
            'mark_img':'./img/j.png',
            'matrix': [
                [canvasPosition.width * 0.65, canvasPosition.height * 0.719],
                [canvasPosition.width * 0.658, canvasPosition.height * 0.76],
                [canvasPosition.width * 0.874, canvasPosition.height * 0.749],
                [canvasPosition.width * 0.735, canvasPosition.height * 0.663],
            ],     // 各頂点の座標
            'origin': {     // 回転時の座標計算用に元座標を保存
                'crossPoint': [],
                'circle': [],
        ...
        baseShape[3] = {
            ...
            'mark_img':'./img/i.png',
            'matrix': [
                [canvasPosition.width * 0.587, canvasPosition.height * 0.59],
                [canvasPosition.width * 0.589, canvasPosition.height * 0.754],
                [canvasPosition.width * 0.686, canvasPosition.height * 0.55],
                [canvasPosition.width * 0.653, canvasPosition.height * 0.484],
            ],     // 各頂点の座標
            'origin': {     // 回転時の座標計算用に元座標を保存
                'crossPoint': [],
                'circle': [],
        ...
        baseShape[3]['initSquare'] = [baseShape[3]['square'][0], baseShape[3]['square'][1]];  // 初期の回転アイコンの中心
    ...
    ShapeService.prototype.calcCenterOfGravity = function (shape) {
        ...
        shape['square'] = [shape['matrix'][1][0] - 10, shape['matrix'][1][1] + 30];
    };
